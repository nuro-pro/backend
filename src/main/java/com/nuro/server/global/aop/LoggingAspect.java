package com.nuro.server.global.aop;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.nuro.server..service..*(..))")
    ...
    @After("execution(* com.nuro.server..service..*(..))")
    ...
    @AfterThrowing(
            pointcut = "execution(* com.nuro.server..service..*(..))",
            throwing = "ex"
    )
